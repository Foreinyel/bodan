...
matches = session.query(Match500).filter(Match500.predict_win_no_win == 1,
                                         Match500.start_time >= '2017-01-01').order_by(Match500.start_time).all()
